...
first_sequence = data['P.1/EPI_ISL_3842262/North']
first_sequence
        ...
        while (n < 10000):
            ...
            for sequence in sequence_new[n]:
                if sequence == 'A':
                    ...
                    sequence_new = sequence_new[0:n]+'C'+sequence_new[n+1:]  
            print('Check the previous 1000 sequence and current 900 sequence:',n, sequence_new[n-1000:n+900:100])
            string = ">New Sequence\n"
