...
##3D
ax = plt.axes(projection='3d')
xline=principalComponents5[:,0]
yline=principalComponents5[:,1]
zline=principalComponents5[:,2]
ax.scatter3D(xline, yline, zline,c=zline,cmap='BrBG_r')
ax.set_xlabel('principal component 1')
ax.set_ylabel('principal component 2')
ax.set_zlabel('principal component 3')
...
##3D
ax = plt.axes(projection='3d')
xline=principalComponents7[:,0]
yline=principalComponents7[:,1]
zline=principalComponents7[:,2]
ax.scatter3D(xline, yline, zline,c=zline,cmap='BrBG_r')
ax.set_xlabel('principal component 1')
ax.set_ylabel('principal component 2')
ax.set_zlabel('principal component 3')
